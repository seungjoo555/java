...
<body>
	<form action="<c:url value="/mypage"/>" method="post">
		...
		<div class="form-group">
		  ...
		  <label id="pw-error" class="error text-danger" for="pw2"></label>
		</div>
		<div class="form-group">
		...
		<button type="button" class="btn btn-outline-success col-12 btn-submit">내 정보 수정</button>
		<div class="box-pw">
			<h3>기존 비밀번호를 입력하세요.</h3>
			<input class="form-control" name="old_pw" type="password">
			<button type="button" class="btn btn-outline-success btn-pw-send">확인</button>
		</div>
	</form>
