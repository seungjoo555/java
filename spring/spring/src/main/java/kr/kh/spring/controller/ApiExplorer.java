...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=SI7BGOxkOEDKm9y8sa8%2BMjpp%2Fmy8ig%2Bpy%2BvkRzZo03%2BAFll%2Fwu57Jg8PQSQIOcr3gLAOgE%2FEIWyiK0%2BM291Hmw%3D%3D"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("searchDate","UTF-8") + "=" + URLEncoder.encode("2024-04-29", "UTF-8")); /*통보시간 검색(조회 날짜 입력이 없을 경우 한달동안 예보통보 발령 날짜의 리스트 정보를 확인)*/
